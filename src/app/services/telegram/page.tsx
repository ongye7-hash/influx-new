  ...
  return (
    <div className="min-h-screen bg-[#09090b] antialiased">
      ...
      <section className="relative py-16 sm:py-20 md:py-32 overflow-hidden">
        {/* Background */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#09090b] via-sky-950/20 to-[#09090b]" />
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-3 gap-4 sm:gap-6 mt-12 sm:mt-16 max-w-xl mx-auto">
              <div className="text-center">
                <div className="text-3xl font-bold font-mono text-white">50M+</div>
                <div className="text-sm text-white/40">누적 구독자</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold font-mono text-white">99.7%</div>
